...
lib.frame = lib.frame or CreateFrame("Frame", BackdropTemplateMixin and "BackdropTemplate")
...
lib.scanTip = lib.scanTip or CreateFrame("GameTooltip", "LibClassicDurationsScanTip", nil, BackdropTemplateMixin and "BackdropTemplate", "GameTooltipTemplate")
...
function lib:ToggleDebug()
    if not lib.debug then
        lib.debug = CreateFrame("Frame", BackdropTemplateMixin and "BackdropTemplate")
...
lib.setwatcher = lib.setwatcher or CreateFrame("Frame", nil, UIParent, BackdropTemplateMixin and "BackdropTemplate")
