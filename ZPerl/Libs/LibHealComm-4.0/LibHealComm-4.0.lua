...
if( not HealComm.tooltip ) then
	local tooltip = CreateFrame("GameTooltip", BackdropTemplateMixin and "BackdropTemplate")
...
HealComm.bucketFrame = HealComm.bucketFrame or CreateFrame("Frame", BackdropTemplateMixin and "BackdropTemplate")
...
if( not HealComm.hotMonitor ) then
	HealComm.hotMonitor = CreateFrame("Frame", BackdropTemplateMixin and "BackdropTemplate")
...
function HealComm:OnInitialize()
	...
	self.resetFrame = CreateFrame("Frame", BackdropTemplateMixin and "BackdropTemplate")
	self.resetFrame:Hide()
...
-- Event handler
HealComm.eventFrame = HealComm.frame or HealComm.eventFrame or CreateFrame("Frame", BackdropTemplateMixin and "BackdropTemplate")
