...
local MSA_DropDownMenuDelegate = CreateFrame("FRAME", BackdropTemplateMixin and "BackdropTemplate");
...
local function CreateDropDownMenuButton(name, parent)
    local DropDownMenuButton = CreateFrame("Button", name, parent or nil, BackdropTemplateMixin and "BackdropTemplate")
    ...
    local button1 = CreateFrame("Button", name.."ColorSwatch", DropDownMenuButton, BackdropTemplateMixin and "BackdropTemplate")
    button1:Hide()
    button1:SetWidth(16)
    ...
    local button2 = CreateFrame("Button", name.."ExpandArrow", DropDownMenuButton, BackdropTemplateMixin and "BackdropTemplate")
    button2:Hide()
    button2:SetWidth(16)
    ...
    local button3 = CreateFrame("Button", name.."InvisibleButton", DropDownMenuButton, BackdropTemplateMixin and "BackdropTemplate")
...
local function CreateDropDownMenu(name, parent)
    ...
    if type(name) == "table" then
        ...
        DropDownMenu = CreateFrame("Frame", name, parent or nil, BackdropTemplateMixin and "BackdropTemplate")
    end
    ...
    local button1 = CreateFrame("Button", name.."Button", DropDownMenu, BackdropTemplateMixin and "BackdropTemplate")
...
-- Init skins
lib.initFrame = lib.initFrame or CreateFrame("Frame", BackdropTemplateMixin and "BackdropTemplate")
